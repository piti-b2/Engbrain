...
GRANT USAGE, SELECT ON SEQUENCE course_access_id_seq TO authenticated;
GRANT USAGE, SELECT ON SEQUENCE course_access_id_seq TO anon;
...
-- Function to extend course access (unchanged)
