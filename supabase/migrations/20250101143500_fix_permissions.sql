-- Disable RLS
ALTER TABLE public.course_access DISABLE ROW LEVEL SECURITY;

-- Drop existing policies
DROP POLICY IF EXISTS "Enable all access to authenticated users" ON "public"."course_access";

-- Grant permissions to both authenticated and anon
GRANT SELECT, INSERT, UPDATE ON public.course_access TO authenticated;
GRANT SELECT, INSERT, UPDATE ON public.course_access TO anon;
...
GRANT EXECUTE ON FUNCTION public.extend_course_access_v2 TO anon;
